...
class DarkPhoton():
    ...
    def Haloscopes(ax,fs=17,projection=True,text_on=True,col='darkred'):
        ...
        if text_on:
            plt.text(1.4e-6,0.5e-14,r'ADMX',fontsize=fs,color=col,rotation=90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
            plt.text(0.8e-5,0.1e-13,r'CAPP',fontsize=fs-2,color=col,rotation=90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
            plt.text(0.19e-4,3e-15,r'HAYSTAC',fontsize=fs-5,color=col,rotation=90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
            plt.text(0.47e-4,3e-12,r'QUAX',fontsize=fs-8,color=col,rotation=-90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def StellarBounds(ax,fs=19,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(0.8e2,1.5e-14,r'Solar',fontsize=fs,color='w',rotation=-41,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(1e3,0.7e-14,r'HB',fontsize=fs,color='w',rotation=-38,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(0.7e4,0.68e-14,r'RG',fontsize=fs,color='w',rotation=-37,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
        return
    ...
    def Xenon(ax,col='crimson',fs=23,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(8e2,2.5e-17,r'XENON',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
            #plt.text(0.65e-3,2.4e-11,r'XENON1T',color='w',rotation=-41,fontsize=15,path_effects=line_background(1,'k'),clip_on=True)
    ...
    def DAMIC(ax,col='salmon',fs=21,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(4e-1,1.3e-14,r'DAMIC',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def MuDHI(ax,col='#400927',fs=15,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(0.18e-2,1e-11,r'MuDHI',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def FUNK(ax,col='red',fs=21,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(1.9e-1,0.8e-13,r'FUNK',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def SENSEI(ax,col='firebrick',fs=21,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(1.7e0,1e-15,r'SENSEI',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def SuperCDMS(ax,col=[0.4,0,0],fs=18,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(0.5e1,1.5e-16,r'SuperCDMS',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def Nanowire(ax,col='pink',fs=22,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(5e-4,1e-10,r'WSi Nanowire',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def SQMS(ax,col='#02734b',fs=17,text_on=True,lw=0.5,ms=10):
        ...
        if text_on:
            plt.text(5.7e-6,0.65e-14,r'SQMS',fontsize=fs,color=col,rotation=-90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
        return
    ...
    def LAMPOST(ax,col='#471710',fs=15,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(0.3e-1,4.5e-13,r'LAMPOST',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def Tokyo(ax,col='darkred',fs=15,text_on=True,lw=1.5):
        ...
        if text_on:
            #plt.text(2e-4,1e-10,r'Tokyo-3',fontsize=fs,color=col,rotation=-90,rotation_mode='anchor',ha='center',va='center')
            plt.text(0.45e-3,3e-8,r'Tokyo-2',fontsize=fs-2,color='k',rotation=90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
            plt.text(0.03e-1,2e-12,r'Tokyo-1',fontsize=fs+4,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def FAST(ax,col='tomato',fs=10,text_on=True,lw=1.5,edge_on=False,zorder=0.11):
        ...
        if text_on:
            plt.text(7e-6,4e-12,r'FAST',fontsize=fs,color=col,rotation=-90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
        return
    ...
    def LOFAR(ax,col='red',fs=10,text_on=True,lw=1.5,edge_on=False,zorder=0.11):
        ...
        if text_on:
            plt.text(1.95e-7,3e-14,r'LOFAR (Sun)',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
        return
    ...
    def Jupiter(ax,col='Green',fs=15,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(0.1e-14,4.5e-1,r'Jupiter',fontsize=fs,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1,'k'),clip_on=True)
        return
    ...
    def Earth(ax,col='DarkGreen',fs=17,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(0.4e-13,2e-1,r'Earth',fontsize=fs,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1,'k'),clip_on=True)
        return
    ...
    #     plt.fill_between(dat[:,0],dat[:,1],y2=y2,edgecolor=None,facecolor=col,zorder=1.9)
        if text_on:
            plt.text(0.5e-6,3e-1,r'Crab',fontsize=fs,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1,'k'),clip_on=True)
            plt.text(0.8e-6,0.9e-1,r'nebula',fontsize=fs,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1,'k'),clip_on=True)
    ...
    def QUALIPHIDE(ax,col='r',fs=9,text_on=True,edge_on=False,lw=0.8,zorder=0):
        ...
        if text_on:
            plt.text(3.5e-5,0.13e-12,r'QUALIPHIDE',fontsize=fs,color=col,rotation=-90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
        return
    ...
    def SHUKET(ax,col='maroon',fs=13,text_on=False,edge_on=False,lw=0.8):
        ...
        if text_on:
            plt.text(3.5e-5,0.13e-12,r'SHUKET',fontsize=fs,color=col,rotation=-90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
        return
    ...
    def DarkEfield(ax,col='darkred',fs=17,text_on=True,edge_on=False,lw=0.8):
        ...
        if edge_on:
            plt.plot(dat[:,0],dat[:,1],'k-',lw=lw,zorder=0.2)
        if text_on:
            plt.text(0.8e-7/1.2,0.2e-12,r'Dark',fontsize=fs,color=col,rotation=90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
            plt.text(2e-7/1.2,0.2e-12,r'E-field',fontsize=fs,color=col,rotation=90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
        return
    ...
    def ORPHEUS(ax,col='darkred',fs=10,text_on=True,edge_on=False,lw=0.8):
        ...
        if edge_on:
            plt.plot(dat[:,0],dat[:,1],'k-',lw=lw,zorder=0.2)
        if text_on:
            plt.text(6.5e-5,0.5e-13,r'ORPHEUS',color=col,rotation=-90,fontsize=fs,clip_on=True)
        return
    ...
    def WISPDMX(ax,col='crimson',fs=12,text_on=True,edge_on=False,lw=0.8):
        ...
        if text_on:
            plt.text(9e-7,4.1e-12/1.2,r'WISP',fontsize=fs,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
            plt.text(9e-7,1.8e-12/1.2,r'DMX',fontsize=fs,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def DOSUE(ax,col='red',fs=9,text_on=True,edge_on=False,lw=0.8):
        ...
        if text_on:
            plt.text(90e-6,0.26e-10,r'DOSUE-RR',fontsize=fs,color=col,rotation=-90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
        return
    ...
    def SQuAD(ax,col=[0.7,0,0],fs=12,text_on=True,lw=0.5,point_on=False,ms=10):
        ...
        if text_on:
            plt.text(36e-6,0.25e-14,r'SQuAD',fontsize=fs,color=col,rotation=-90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
        return
    ...
    def DMPathfinder(ax,col='pink',fs=13,text_on=True):
        ...
        if text_on:
            plt.text(2.1e-9,0.5e-8/1.9,r'DM',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
            plt.text(2.1e-9,0.2e-8/1.9,r'Pathfinder',fontsize=fs,color=col,rotation=0,rotation_mode='anchor',ha='center',va='center',clip_on=True)
    ...
    def QuantumCyclotron(ax,col='orangered',fs=13,text_on=True):
        ...
        if text_on:
            plt.text(0.95e-3,1e-10,r'QC',fontsize=fs,color=col,rotation=-90,rotation_mode='anchor',ha='center',va='center',clip_on=True)
        return
    ...
    def DarkMatter(ax,Witte_col='royalblue',Caputo_col='dodgerblue',Arias_col='navy',fs=20,projection=True,text_on=True):
        ...
        if text_on:
            plt.gcf().text(0.295,0.42-0.04,r'DPDM HeII',fontsize=15,color='w',ha='center',path_effects=line_background(1.5,'k'),clip_on=True)
            ...
            plt.gcf().text(0.365,0.37,r'DPDM',fontsize=17,color='w',ha='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.gcf().text(0.365,0.35,r'(Witte et al.)',fontsize=13,color='w',ha='center',clip_on=True)

            plt.gcf().text(0.485,0.43,r'DPDM',rotation=21.5,fontsize=18,color='w',va='center',ha='center',path_effects=line_background(1.5,'k'),rotation_mode='anchor',clip_on=True)
    ...
    def COBEFIRAS(ax,col=[0.1,0.2,0.5],text_on=True,lw=1.5):
        ...
        if text_on:
            plt.gcf().text(0.29,0.70,r'COBE/FIRAS',fontsize=22,color='w',ha='center',path_effects=line_background(1.5,'k'),clip_on=True)
    ...
    #     plt.fill_between(dat[:,0],dat[:,1],y2=y2,edgecolor=None,facecolor=[0.65, 0.15, 0.2],zorder=1.089)
        ...
        if text_on:
            plt.text(0.4e-6,0.15e-3,r'LSW-ADMX',fontsize=17,color='w',rotation=-58,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(1e-5,5e-5,r'LSW-UWA',fontsize=14,color='w',rotation=-56,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(0.55e0,0.9e-4,r'LSW-SPring-8',fontsize=13,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(1.2e-4,0.9e-5,r'ALPS',fontsize=25,color='w',rotation=-56,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(0.75e-7,9.9e-5,r'CROWS',fontsize=24,color='w',rotation=-56,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(8.2e-7,0.4e-8,r'DarkSRF',fontsize=17,color='w',rotation=-42,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
    ...
    def Coulomb(ax,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(2.5e-10,0.35e-1,r'Plimpton-Lawton',fontsize=15,color='w',rotation=-38,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(3e1,3e-1,r'AFM',fontsize=20,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(0.5e-8,4e-6,r'Cavendish-Coulomb',fontsize=23,color='w',rotation=-38,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(0.2e2,1e-3,r'Spectroscopy',fontsize=23,color='w',rotation=-34,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
    ...
    def NeutronStarCooling(ax,col='#004d00',fs=18,text_on=True,lw=1.5):
        ...
        plt.plot(dat[:,0],dat[:,1],color='k',alpha=1,zorder=1.1001,lw=lw)
        if text_on:
            plt.text(0.9e4,0.4e-6,r'Neutron stars',fontsize=fs,color='w',rotation=-45,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1,'k'),clip_on=True)
        return
    ...
    def CAST(ax,col='maroon',fs=19,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(0.95e-3,6e-6,r'CAST',fontsize=fs,color='w',rotation=-59,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
        return
    ...
    def HINODE(ax,col='#700606',fs=16,text_on=True,lw=1.5):
        ...
        plt.plot(dat[:,0],dat[:,1],color='k',alpha=1,zorder=1.1001,lw=lw)
        if text_on:
            plt.text(5e-3,0.3e-5,r'HINODE',fontsize=fs,color='w',rotation=-59,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
        return
    ...
    def SHIPS(ax,col='indianred',fs=20,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(0.6e-1,0.08e-8,r'SHIPS',fontsize=fs,color='w',rotation=-32,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
        return
    ...
    def TEXONO(ax,col=[0.5, 0.0, 0.13],fs=15,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(0.25e2,0.1e-4,r'TEXONO',fontsize=fs,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
        return
    ...
    def IGM(ax,col='seagreen',fs=18,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(4e-12,0.03e-7,r'IGM',fontsize=fs,color='w',rotation=-39,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.gcf().text(0.233,0.565,r'DPDM heating',color='w',fontsize=23,path_effects=line_background(1.5,'k'))
    ...
    def LeoT(ax,col='mediumseagreen',fs=18,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(7e-13,0.2e-9,r'Leo T',fontsize=fs,color='w',rotation=-39,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
        return
    ...
    def GasClouds(ax,col='#00cc66',fs=18,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(0.86e-13,1e-10,r'Gas clouds',fontsize=fs,color='w',rotation=-38.5,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
        return
    ...
    def SuperMAG(ax,col='#b5403e',fs=18,text_on=True,lw=1.5):
        ...
        if text_on:
            plt.text(1.5e-17,1e-1/1.4,r'Super',fontsize=fs,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
            plt.text(1.5e-17,0.2e-1/1.4,r'MAG',fontsize=fs,color='w',rotation=0,rotation_mode='anchor',ha='center',va='center',path_effects=line_background(1.5,'k'),clip_on=True)
...
##############################################################################################################################################################
    ...
    def IAXO(ax,col='magenta',fs=30,text_on=True,lw=2.5,pureL=False):
        ...
        if pureL:
            ...
            datGas = loadtxt("../data/limits/stats-babyIAXO{.dat".format(suffix))
            ...
            datGas = loadtxt("../data/limits/stats-baselineIAXO{.dat".format(suffix))
            plt.plot(datGas[:,0],datGas[:,1],color='black',alpha=1,zorder=0.003,lw=lw, ls='--')
            plt.fill_between(datGas[:,0],datGas[:,1],y2=y2,edgecolor=None,facecolor=col,zorder=0.003, alpha=1.)
            ...
            if text_on:
                plt.text(1e-1,5e-11,r'babyIAXO',fontsize=25,color='black',rotation=-33,rotation_mode='anchor',ha='center',va='center', zorder=105.5)
    ...
    #		upgradedIAXO
            ...
            if text_on:
                plt.text(1e-1,5e-11,r'IAXO',fontsize=fs,color='white',rotation=-32,rotation_mode='anchor',ha='center',va='center', zorder=105.5)
