...
# original
dat = loadtxt("AxionLimits/limit_data/DarkPhoton/IAXO/babyIAXO-tPlasmon-clean.dat")
ax2.plot(dat[:,0],dat[:,1], color='black', label='T-plasmon')

# 1day gas original
dat = loadtxt("AxionLimits/limit_data/DarkPhoton/IAXO/babyIAXO-tPlasmon-clean-gas.dat")
ax2.plot(dat[:,0],dat[:,1], color='green', label='T-plasmon (gas)')

# L-plasmon new
dat = loadtxt("AxionLimits/limit_data/DarkPhoton/IAXO/babyIAXO-clean-lMixingRes.dat")
ax2.plot(dat[:,0], dat[:,1], color='red', label='L-plasmon mixing')

# L-plasmon new gas
dat = loadtxt("AxionLimits/limit_data/DarkPhoton/IAXO/babyIAXO-clean-lMixingResGas.dat")
ax2.plot(dat[:,0], dat[:,1], color='magenta', label='L-plasmon mixing (gas)')

# pure L contribution
dat = loadtxt("AxionLimits/limit_data/DarkPhoton/IAXO/babyIAXO-clean-pureL.dat")
