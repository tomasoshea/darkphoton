...
ax2.set(xlim=(1e-4,1e4), ylim=(1e-14,3e-5))
...
# tPlasmon new 95%
dat = loadtxt("data/limits/stats-babyIAXO-tPlasmon.dat")
ax2.plot(dat[:,0],dat[:,1], color='red', ls=':', label='T-plasmon CL95')

# tPlasmon gas newE
#dat = loadtxt("data/limits/babyIAXO-tPlasmon-100eV-gas.dat")
#ax2.plot(dat[:,0],dat[:,1], color='green', label='T-plasmon (gas)')

#dat = loadtxt("data/limits/stats-babyIAXO-tPlasmonGas.dat")
#ax2.plot(dat[:,0],dat[:,1], color='green', ls=':',  label='T-plasmon (gas) CL95')
